...
type ProjectStepProps = {
  ...
  onChange: <K extends keyof ProjectData>(
    field: K,
    value: ProjectData[K],
  ) => void;
};
    ...
    <div>
      ...
      <div className="border-b border-[#e0e7ec] pb-7">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-[#667887] sm:text-base">
          Informe os dados que se aplicam ao
          projeto como um todo. Os detalhes
          específicos de cada peça permanecem
          associados aos itens cadastrados na
          etapa anterior.
        </p>
      </div>
