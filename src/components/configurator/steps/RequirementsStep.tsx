...
import type {
  CtRequirements as CtRequirementsData,
  DimensionalRequirements as DimensionalRequirementsData,
  PieceConfiguration,
  ReverseEngineeringRequirements as ReverseEngineeringRequirementsData,
  ScanningRequirements as ScanningRequirementsData,
  ServiceId,
} from "../types";
...
export function RequirementsStep({
  ...
  /*
   * Quando o usuário troca de peça,
   * garantimos que o serviço ativo exista
   * naquela nova peça.
   */
  useEffect(() => {
    if (!activePiece) {
  ...
  /* =========================================================
     UPDATE CENTRAL DA PEÇA
  ========================================================= */

  function updatePiece(
    nextPiece: PieceConfiguration,
  ) {
    onPiecesChange(
      pieces.map(
        (piece) =>
  ...
  /* =========================================================
     UPDATE — ENGENHARIA REVERSA
  ========================================================= */

  function updateReverseEngineering(
    requirements:
      ReverseEngineeringRequirementsData,
  ) {
    updatePiece({
      ...activePiece,
    ...
    <div>
      ...
      0 ? (
        ...
        <>
          ...
          {/* =================================================
              NAVEGAÇÃO INTERNA ENTRE SERVIÇOS
          ================================================= */}
