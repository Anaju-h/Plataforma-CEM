...
export function Configurator() {
  ...
  function goNext() {
    ...
    /*
     * Caso a Etapa 4 não tenha nenhuma informação
     * útil para refinar, ainda mantemos o passo disponível,
     * porque ele apresenta ao usuário que a configuração
     * já possui boa definição.
     */
  ...
  function handleProjectServicesChange(
    ...
    setState(
      (current) => ({
        ...
        /*
         * Na primeira definição do projeto, a primeira
         * peça acompanha as necessidades escolhidas.
         *
         * Depois, na Etapa 02, cada peça pode ser
  ...
  function handlePiecesChange(
        ...
        pieces:
          current.pieces.map(
            (
              ...
              /*
               * Se serviços mudaram, removemos requisitos
               * de serviços que deixaram de existir.
               */
              return clearRemovedServiceRequirements(
                {
                  ...nextPiece,
    ...
    /*
     * A função acima trata peças já existentes.
     * Também precisamos aceitar novas peças recebidas.
     */
  ...
  async function handleSubmit() {
    ...
    try {
       ...
       * });
       *
       * Por enquanto NÃO fingimos integração com backend.
       * Apenas concluímos a experiência local para que
       * a UI do configurador possa ser validada.
       */
          ...
          <div className="order-1 lg:order-2">
            <div className="overflow-visible rounded-[26px] border border-[#c9d7df] bg-[#f5f9fb] shadow-[0_22px_65px_rgba(34,67,90,0.08)] sm:rounded-[30px]">
              ...
              {/* =================================================
                  ...
                  Etapa 05 possui seu próprio botão de envio.
              ================================================= */}
...
function canContinueCurrentStep(
  ...
  if (
    ...
    /*
     * Refinamento nunca prende o usuário.
     *
     * Pode existir informação que ele simplesmente
     * não sabe responder.
     */
    return true;
  }
