...
public final class RequestDtos {
  ...
  public record Create(@NotNull @Valid Contact contact,@NotNull @Valid Project project,Internal internal,List<@Valid Piece> pieces,String origin,String channel) {}
  ...
  public record Response(String id,String technicalId,String source,String visibility,String origin,String channel,String company,String contact,String email,String phone,String requestNeedId,String service,List<String> services,String createdAt,String updatedAt,String status,String priority,String responsible,int parts,String objective,String comments,String internalNotes,Map<String,Object> customer,Map<String,Object> project,List<Map<String,Object>> piecesData,List<Map<String,Object>> attachments,String linkedQuoteId,Map<String,Object> cancellation,Analysis analysis,List<History> history) {}
}
